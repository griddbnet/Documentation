...
<img src="/img-ja/arc_clusterNameCount.png" alt="クラスタ名と構成ノード数" width="500"/>
<br>
...
次にクラスタ構成の操作の流れを示します。
  ...
  <img src="/img-ja/arc_clusterConfigration.png" alt="クラスタ構成の動作" width="600"/>
...
<img src="/img-ja/arc_NodeStatus.png" alt="ノードステータス" width="600"/>
...
<img src="/img-ja/arc_clusterStatus.png" alt="クラスタステータス" width="500"/>
