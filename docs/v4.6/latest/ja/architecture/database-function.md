...
<img src="/img-ja/arc_DatabaseFile.png" alt="データベースファイル" width="800"/>
...
-   TQLとは
    ...
    TQLの詳細は『[GridDB TQLリファレンス](../tqlreference/introduction.md)』を参照ください。
...
-   SQLとは
    ...
    SQLの詳細は『[GridDB SQLリファレンス](../sqlreference/introduction.md)』を参照ください。
...
<img src="/img-ja/func_multiput.png" alt="multiput処理" width="500"/>
...
<img src="/img-ja/func_multiquery.png" alt="fetchAll処理" width="500"/>
...
<img src="/img-ja/func_multiget.png" alt="multiget処理" width="500"/>
...
指定されたカラムが条件を満たし、それ以外のカラムの値が前回のデータと同じ場合のみロウデータは省かれます。条件は、誤差の幅(Width)で指定します。
  ...
  <img src="/img-ja/func_TimeseriseCompression.png" alt="時系列コンテナ(時系列テーブル)の圧縮" width="700"/>
...
- TIME_AVG
  ...
  <img src="/img-ja/func_TIME_AVG.png" alt="重みづけの集計演算（TIME_AVG)" width="500"/>
...
<img src="/img-ja/func_expiration.png" alt="期限解放" width="700"/>
...
<img src="/img-ja/func_expiration_row.png" alt="ロウ期限解放" width="700"/>
...
-   パーティション期限解放
    ...
    データパーティションの削除方法は『[GridDB SQLリファレンス](../sqlreference/introduction.md))』をご参照ください。


  <img src="/img-ja/func_expiration_partition.png" alt="パーティション期限解放" width="800"/>
...
<img src="/img-ja/func_partitioning.png" alt="テーブルパーティショニング" width="500"/>
...
<img src="/img-ja/func_partitioning2.png" alt="テーブルパーティショニングを使用しない場合" width="700"/>
...
<img src="/img-ja/func_partitioning3.png" alt="テーブルパーティショニングを使用する場合" width="700"/>
...
<img src="/img-ja/func_partitioning_hash.png" alt="ハッシュパーティショニング" width="800"/>
...
<img src="/img-ja/func_partitioning_interval.png" alt="インターバルパーティショニング" width="800"/>
...
-   データパーティションの削除
    ...
    メタテーブルの詳細は『[GridDB SQLリファレンス](../sqlreference/introduction.md)』をご参照ください。
...
-   データパーティションのメンテナンス
    ...
    -   データパーティション数の確認方法
        ...
        データパーティションの情報を管理しているメタテーブルを参照して確認します。詳細は『[GridDB SQLリファレンス](../GridDB_SQL_Reference/introduction.md)』を参照ください。

    -   データパーティションの削除方法

        テーブルパーティションの下限値を指定して削除を行います。詳細は『[GridDB SQLリファレンス](../GridDB_SQL_Reference/introduction.md)』を参照ください。


<img src="/img-ja/func_partitioning_interval2.png" alt="インターバルパーティションテーブル作成・削除の例" width="350"/>
...
<img src="/img-ja/func_partitioning_interval_hash.png" alt="インターバル-ハッシュパーティショニング" width="800"/>
...
<img src="/img-ja/func_partitioning4.png" alt="データの範囲" width="500"/>
...
- インターバルパーティショニング、インターバル-ハッシュパーティショニング
  ...
  <img src="/img-ja/func_partitioning_interval3.png" alt="インターバルパーティショニング" width="700"/>
  ...
  <img src="/img-ja/func_partitioning_interval4.png" alt="インターバルパーティショニングの登録と検索処理の例" width="1000"/>
  ...
  <img src="/img-ja/func_partitioning_interval_hash2.png" alt="インターバルハッシュパーティショニング" width="700"/>
...
- ハッシュパーティショニング
  ...
  <img src="/img-ja/func_partitioning_hash2.png" alt="ハッシュパーティショニング" width="700"/>
  ...
  <img src="/img-ja/func_partitioning_hash3.png" alt="ハッシュパーティショニングの登録と検索処理の例" width="1100"/>
...
<img src="/img-ja/func_MVCC.png" alt="MVCC" width="700"/>
...
<img src="/img-ja/func_checkpnt.png" alt="チェックポイント" width="500"/>
...
詳細は『<a href="/ja/GridDB_Java_API_Reference.html"> GridDB Java APIリファレンス </a>』や『 <a href="/ja/GridDB_C_API_Reference.html">GridDB C APIリファレンス</a>』を参照ください。
...
<img src="/img-ja/feature_data_afinity.png" alt="データアフィニティ" width="500"/>
...
<img src="/img-ja/func_Node_Affinity.png" alt="ノードアフィニティによるコンテナ/テーブルの配置" width="500"/>
...
<img src="/img-ja/func_trigger.png" alt="トリガ機能の動作" width="500"/>
...
- NoSQL APIの場合
  ...
  - 既存コンテナからコンテナ情報情報ContainerInfoを取得し、コンテナ情報に新しいカラムをセットしてからputContainerを実行します。
    詳細は『 <a href="/ja/GridDB_Java_API_Reference.html"> GridDB Java APIリファレンス </a>』をご参照ください。
...
- JDBC
  ...
  - SQLの場合は、末尾へのカラム追加の操作のみできます。詳細は『[GridDB SQLリファレンス](../sqlreference/introduction.md)』をご参照ください。

カラムを追加した後に既存ロウを取得した場合、追加カラムの値はカラムのデータ型ごとに定義されている「空の値」が返ります。
空の値の詳細は『<a href="/ja/GridDB_Java_API_Reference.html"> GridDB Java APIリファレンス </a>』のContainer&lt;K,R&gt;をご参照ください。
(V4.1では、制限事項「カラム追加後に既存のロウを参照した時、NOT NULL制約が付いていないカラムはNULLが返る」があります。)


<img src="/img-ja/add_column.png" alt="カラム追加の例" width="800"/>
